...
{
	public partial class ShieldsNotBaked : UserControl
	{
		public ShieldsNotBaked()
		{
			InitializeComponent();
		}
		...
		private void address_shields__NonblankLines1_Load(object sender, EventArgs e)
		{
			this.address_shields__NonblankLines1.txt = nilnul.txt.accumulate_.join_._LineSeparatedX.ToWinLines(
				nilnul.dev.raws.bak_._retVoid.SettingX.shieldsNotBaked.OrderBy(
		...
		{
			nilnul.dev.bak.nilnul0.dev.raws.bak_._retVoid.Settings1.Default.shieldsNotBaked= nilnul.txts_.StrCollectionX.FroEnumable(
