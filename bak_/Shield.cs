...
namespace nilnul.dev._bak_._CTR_.ctr_.bak_
{
...
nilnul.dev._bak_._CTR_.Properties.Settings.Default.lastAddress;//.dev.srcs.bak_._retVoid.SettingX.module2bak;
//nilnul.dev._bak_._WIN_.Properties.Settings.Default.lastAddress;//.dev.srcs.bak_._retVoid.SettingX.module2bak;
		...
		{
			nilnul.dev._bak_._CTR_.Properties.Settings.Default.lastAddress = this.shield1.txt;
			nilnul.dev._bak_._CTR_.Properties.Settings.Default.Save();
