using nilnul.dev._bak_._CTR_.ctr_.retVoid_;

namespace nilnul.dev._bak_._CTR_.ctr_.bak_.module_
{
	partial class bak__module_Div
	{
		...
		private void InitializeComponent()
		{
			...
			this.bak___module__start_Cancel1 = new nilnul.dev._bak_._CTR_.ctr_.bak_._module_.start.bak___module__start_Cancel();
