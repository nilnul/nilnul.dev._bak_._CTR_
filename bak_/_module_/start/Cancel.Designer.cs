...
{
	partial class bak___module__start_Cancel
	{
		/// <summary> 
		...
		{
			this.start1 = new nilnul.dev._bak_._CTR_.ctr_.bak_._module_.bak___module__Start();
		...
		private bak___module__Start start1;
	}
}
