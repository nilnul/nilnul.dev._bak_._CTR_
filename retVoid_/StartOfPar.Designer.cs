namespace nilnul.dev._bak_._CTR_.ctr_.retVoid_
{
	partial class StartOfPar
	{
		/// <summary> 
		...
		{
			this.start1 = new nilnul.dev._bak_._CTR_.ctr_._retVoid_.bak___shields__Start();
			this.cancel1 = new nilnul.dev._bak_._CTR_.ctr_._retVoid_.Cancel();
			this.SuspendLayout();
			// 
			// start1
			// 
			...
			this.start1.Size = new System.Drawing.Size(218, 84);
			...
			this.start1.notify += new System.Action<string>(this.Start1_notify);
			...
			this.cancel1.Size = new System.Drawing.Size(218, 84);
