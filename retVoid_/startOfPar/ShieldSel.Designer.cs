namespace nilnul.dev._bak_._CTR_.ctr_.retVoid_.startOfPar
{
	partial class retVoid__startOfPar_ShieldSel
	{
		...
		{
			this.startCtr = new nilnul.dev._bak_._CTR_.ctr_.retVoid_.StartOfPar();
			this.shieldSel1 = new nilnul.dev._bak_._CTR_.ctr_._retVoid_._retVoid__ShieldSel();
			this.SuspendLayout();
			// 
			// startCtr
			// 
