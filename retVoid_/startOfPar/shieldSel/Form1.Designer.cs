namespace nilnul.dev._bak_._CTR_.ctr_.retVoid_.startOfPar.shieldSel
{
	partial class Form1
	{
		/// <summary>
		...
		{
			this.shields1 = new nilnul.dev._bak_._CTR_.ctr_.retVoid_.startOfPar.retVoid__startOfPar_ShieldSel();
			this.SuspendLayout();
			// 
			// shields1
			// 
		...
		private nilnul.dev._bak_._CTR_.ctr_.retVoid_.startOfPar.retVoid__startOfPar_ShieldSel shields1;
	}
}